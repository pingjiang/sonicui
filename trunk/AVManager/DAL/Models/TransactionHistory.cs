...
namespace AVManager.DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class TransactionHistory : ActiveRecord<TransactionHistory>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TransactionHistory", TableType.Table, DataService.GetInstance("Default"));
				...
				DataService.Providers["Default"].AddSchema("TransactionHistory",schema);
			}
