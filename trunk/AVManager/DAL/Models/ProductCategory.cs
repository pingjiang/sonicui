...
namespace AVManager.DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class ProductCategory : ActiveRecord<ProductCategory>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProductCategory", TableType.Table, DataService.GetInstance("Default"));
				...
				DataService.Providers["Default"].AddSchema("ProductCategory",schema);
			}
		...
		public AVManager.DAL.ProductSubcategoryCollection ProductSubcategoryRecords()
		{
			return new AVManager.DAL.ProductSubcategoryCollection().Where(ProductSubcategory.Columns.ProductCategoryID, ProductCategoryID).Load();
		}
