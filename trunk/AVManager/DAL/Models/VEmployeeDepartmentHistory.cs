...
namespace AVManager.DAL{
    /// <summary>
    /// Strongly-typed collection for the VEmployeeDepartmentHistory class.
    /// </summary>
    [Serializable]
    public partial class VEmployeeDepartmentHistoryCollection : ReadOnlyList<VEmployeeDepartmentHistory, VEmployeeDepartmentHistoryCollection>
    {        
        public VEmployeeDepartmentHistoryCollection() {}

    }

    /// <summary>
    /// This is  Read-only wrapper class for the vEmployeeDepartmentHistory view.
    /// </summary>
    [Serializable]
    public partial class VEmployeeDepartmentHistory : ReadOnlyRecord<VEmployeeDepartmentHistory> 
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vEmployeeDepartmentHistory", TableType.View, DataService.GetInstance("Default"));
                ...
                colvarShift.DataType = DbType.String;
                colvarShift.MaxLength = 50;
                colvarShift.AutoIncrement = false;
                colvarShift.IsNullable = false;
                ...
                DataService.Providers["Default"].AddSchema("vEmployeeDepartmentHistory",schema);
            }
        ...
        public VEmployeeDepartmentHistory(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VEmployeeDepartmentHistory(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
	    ...
	    public VEmployeeDepartmentHistory(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string Shift 
	    {
		    get
		    {
			    return GetColumnValue<string>("Shift");
		    }

            set 
		    {
			    SetColumnValue("Shift", value);
            }
