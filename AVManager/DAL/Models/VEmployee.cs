...
namespace AVManager.DAL{
    /// <summary>
    /// Strongly-typed collection for the VEmployee class.
    /// </summary>
    [Serializable]
    public partial class VEmployeeCollection : ReadOnlyList<VEmployee, VEmployeeCollection>
    {        
        public VEmployeeCollection() {}

    }

    /// <summary>
    /// This is  Read-only wrapper class for the vEmployee view.
    /// </summary>
    [Serializable]
    public partial class VEmployee : ReadOnlyRecord<VEmployee> 
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vEmployee", TableType.View, DataService.GetInstance("Default"));
                ...
                DataService.Providers["Default"].AddSchema("vEmployee",schema);
            }
        ...
        public VEmployee(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VEmployee(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string AdditionalContactInfo 
	    {
		    get
		    {
			    return GetColumnValue<string>("AdditionalContactInfo");
		    }

            set 
		    {
			    SetColumnValue("AdditionalContactInfo", value);
            }
